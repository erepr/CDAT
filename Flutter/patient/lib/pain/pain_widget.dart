...
import '../pain_awake/pain_awake_widget.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class PainWidget extends StatefulWidget {
  PainWidget({Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<PatientRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final painPatientRecord = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          ...
                          try {
                            ...
                            await painPatientRecord.reference
                                .update(patientUpdateData);
                            await Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => PainAwakeWidget(),
                              ),
                            );
                          } finally {
