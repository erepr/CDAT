...
import '../blood/blood_widget.dart';
...
class FissureWidget extends StatefulWidget {
  FissureWidget({Key key}) : super(key: key);

  @override
  _FissureWidgetState createState() => _FissureWidgetState();
}

class _FissureWidgetState extends State<FissureWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<PatientRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final fissurePatientRecord = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      CachedNetworkImage(
                        imageUrl: 'https://i.imgur.com/5FxxM4T.png',
                        height: 300,
                        fit: BoxFit.cover,
                      )
                    ],
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          ...
                          try {
                            ...
                            await fissurePatientRecord.reference
